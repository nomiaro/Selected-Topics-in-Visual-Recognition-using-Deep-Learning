...
Put your images under [your dataset name]/ and specify [your dataset name] for --dataset.
...
def main(not_parsed_args):
    ...
    training_filenames = util.get_files_in_directory(FLAGS.dataset + "/")
    target_dir = FLAGS.dataset + ("_%d/" % FLAGS.augment_level)
